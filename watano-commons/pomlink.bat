...
mklink /h %liblinkdir%\commons-io-2.1.jar %M2_REPO%\commons-io\commons-io\2.1\commons-io-2.1.jar
mklink /h %liblinkdir%\sources\commons-io-2.1-sources.jar %M2_REPO%\commons-io\commons-io\2.1\commons-io-2.1-sources.jar
...
mklink /h %liblinkdir%\el-api-1.0.jar %M2_REPO%\javax\el\el-api\1.0\el-api-1.0.jar
mklink /h %liblinkdir%\sources\el-api-1.0-sources.jar %M2_REPO%\javax\el\el-api\1.0\el-api-1.0-sources.jar
...
mklink /h %liblinkdir%\persistence-api-1.0.2.jar %M2_REPO%\javax\persistence\persistence-api\1.0.2\persistence-api-1.0.2.jar
mklink /h %liblinkdir%\sources\persistence-api-1.0.2-sources.jar %M2_REPO%\javax\persistence\persistence-api\1.0.2\persistence-api-1.0.2-sources.jar
