...
mklink /h %liblinkdir%\jackson-core-asl-1.9.7.jar %M2_REPO%\org\codehaus\jackson\jackson-core-asl\1.9.7\jackson-core-asl-1.9.7.jar
mklink /h %liblinkdir%\sources\jackson-core-asl-1.9.7-sources.jar %M2_REPO%\org\codehaus\jackson\jackson-core-asl\1.9.7\jackson-core-asl-1.9.7-sources.jar
mklink /h %liblinkdir%\jackson-jaxrs-1.9.7.jar %M2_REPO%\org\codehaus\jackson\jackson-jaxrs\1.9.7\jackson-jaxrs-1.9.7.jar
mklink /h %liblinkdir%\sources\jackson-jaxrs-1.9.7-sources.jar %M2_REPO%\org\codehaus\jackson\jackson-jaxrs\1.9.7\jackson-jaxrs-1.9.7-sources.jar
mklink /h %liblinkdir%\jackson-mapper-asl-1.9.7.jar %M2_REPO%\org\codehaus\jackson\jackson-mapper-asl\1.9.7\jackson-mapper-asl-1.9.7.jar
mklink /h %liblinkdir%\sources\jackson-mapper-asl-1.9.7-sources.jar %M2_REPO%\org\codehaus\jackson\jackson-mapper-asl\1.9.7\jackson-mapper-asl-1.9.7-sources.jar
mklink /h %liblinkdir%\jackson-xc-1.9.7.jar %M2_REPO%\org\codehaus\jackson\jackson-xc\1.9.7\jackson-xc-1.9.7.jar
mklink /h %liblinkdir%\sources\jackson-xc-1.9.7-sources.jar %M2_REPO%\org\codehaus\jackson\jackson-xc\1.9.7\jackson-xc-1.9.7-sources.jar
